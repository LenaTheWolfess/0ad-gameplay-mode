	...
	else
	{
		if (template.requiredTechnology)
		{
			let technologyEnabled = Engine.GuiInterfaceCall("AreTechnologiesResearched", {
				"techs": template.requiredTechnology,
			...
			if (!technologyEnabled)
			{
				...
				tooltips.push(getRequiredTechnologiesTooltip(technologyEnabled, template.requiredTechnology, GetSimState().players[g_ViewedPlayer].civ));
			}
		}
