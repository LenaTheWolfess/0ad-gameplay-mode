...
function init(data)
{
	...
	let isFormation = formationDataExists(templateName);
	...
	if (isFormation)
		g_Template = loadFormationTempalte(templateName);
	else
	...
	g_StatsFunctions = [getEntityCostTooltip, getFormationTooltip].concat(g_StatsFunctions);
