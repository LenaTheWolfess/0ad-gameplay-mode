...
Identity.prototype.Schema =
	...
	"</optional>" +
	"<optional>" +
		"<element name='SelectionGroupName' a:help='Name used to group ranked entities.'>" +"<text/>" +
		"</element>" +
	"</optional>" +
	"<optional>" +
	...
	"</optional>" +
	"<optional>"+
	    "<element name='BannerCode'>"+
		    "<text/>"+
	    "</element>"+
	"</optional>"+
	"<optional>" +
	   "<element name='FormationGroup'>"+
	        "<text/>"+
	   "</element>"+
	"</optional>"+
	"<optional>"+
	   "<element name='FormationCompany'>"+
	       "<text/>"+
	   "</element>"+
	"</optional>"+
	"<optional>" +
...
Identity.prototype.GetFormationGroup = function()
{
	return this.template.FormationGroup || null;
}
...
Identity.prototype.HasBannerCode = function()
{
	return !!this.template.BannerCode;
}
Identity.prototype.GetBannerCode = function()
{
	if (this.template.BannerCode)
		return this.template.BannerCode;
	return "";
}
Identity.prototype.GetFormationCompany = function()
{
	if (this.template.FormationCompany)
		return this.template.FormationCompany;
	return "";
}
Identity.prototype.HasFormationCompany = function()
{
	return !!this.template.FormationCompany;
}
