...
TechnologyManager.prototype.CanProduce = function (templateName)
{
	...
	let template = cmpTempManager.GetTemplate(templateName);

	if (template.Identity && template.Identity.RequiredTechnology && template.Identity.RequiredTechnology._string)
		return this.AreTechnologiesResearched(template.Identity.RequiredTechnology._string.split(/\s+/));
...
TechnologyManager.prototype.AreTechnologiesResearched = function(techs)
{
