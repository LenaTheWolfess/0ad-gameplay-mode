...
m.AttackPlan = function(gameState, Config, uniqueID, type, data)
{
	...
	{
		priority = 250;
		this.unitStat.Infantry = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry"],
			"interests": [["strength", 1], ["costsResource", 0.5, "stone"], ["costsResource", 0.6, "metal"]] };
		this.unitStat.Cavalry = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "CitizenSoldier"],
	...
	else if (type == "HugeAttack")
	{
		...
		this.unitStat.RangedInfantry    = { "priority": 0.7, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Ranged", "CitizenSoldier"],
			"interests": [["strength", 3]] };
		this.unitStat.MeleeInfantry     = { "priority": 0.7, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Melee", "CitizenSoldier"],
			"interests": [["strength", 3]] };
		this.unitStat.ChampRangedInfantry = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Ranged", "Champion"],
			"interests": [["strength", 3]] };
		this.unitStat.ChampMeleeInfantry  = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Melee", "Champion"],
			"interests": [["strength", 3]] };
		this.unitStat.RangedCavalry     = { "priority": 0.7, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "Ranged", "CitizenSoldier"],
			"interests": [["strength", 2]] };
		this.unitStat.MeleeCavalry      = { "priority": 0.7, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "Melee", "CitizenSoldier"],
			"interests": [["strength", 2]] };
		this.unitStat.ChampRangedCavalry  = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "Ranged", "Champion"],
			"interests": [["strength", 3]] };
		this.unitStat.ChampMeleeCavalry   = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "Melee", "Champion"],
			"interests": [["strength", 2]] };
	...
	{
		priority = 70;
		this.unitStat.RangedInfantry = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Ranged"],
			"interests": [["canGather", 1], ["strength", 1.6], ["costsResource", 0.3, "stone"], ["costsResource", 0.3, "metal"]] };
		this.unitStat.MeleeInfantry  = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Infantry", "Melee"],
			"interests": [["canGather", 1], ["strength", 1.6], ["costsResource", 0.3, "stone"], ["costsResource", 0.3, "metal"]] };
		this.unitStat.Cavalry = { "priority": 1, "minSize": 1, "targetSize": 2, "batchSize": 1, "classes": ["Cavalry", "CitizenSoldier"],
			"interests": [["strength", 1]] };
		this.neededShips = 3;
